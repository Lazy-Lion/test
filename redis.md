...
## References
[An Introduction to Redis Types and Abstractions](https://redis.io/topics/data-types-intro)
[Redis Commands](https://redis.io/commands) <br />
[Memcached vs Redis](https://www.linkedin.com/pulse/memcached-vs-redis-which-one-pick-ranjeet-vimal)
